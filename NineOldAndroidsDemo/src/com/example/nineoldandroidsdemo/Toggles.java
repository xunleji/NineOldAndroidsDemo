	...
	public void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.tx).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				ObjectAnimator.ofFloat(target, "translationX", 0, 50, -50, 0)
		...
		findViewById(R.id.ty).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				ObjectAnimator.ofFloat(target, "translationY", 0, 50, -50, 0)
						.setDuration(duration).start();
			}
		});
		findViewById(R.id.sx).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				ObjectAnimator.ofFloat(target, "scaleX", 1, 2, 1)
						.setDuration(duration).start();
			}
		});
		findViewById(R.id.sy).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				ObjectAnimator.ofFloat(target, "scaleY", 1, 2, 1)
						.setDuration(duration).start();
			}
		});
		...
		findViewById(R.id.rx).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				ObjectAnimator.ofFloat(target, "rotationX", 0, 180, 0)
						.setDuration(duration).start();
			}
		});
		...
		findViewById(R.id.rz).setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				ObjectAnimator.ofFloat(target, "rotation", 0, 180, 0)
						.setDuration(duration).start();
			}
		});
		findViewById(R.id.pivot_zero_zero).setOnClickListener(
				new OnClickListener() {
					@Override
					public void onClick(View v) {
						// 设置变换中心位于View的左上角
		...
		findViewById(R.id.pivot_center).setOnClickListener(
				new OnClickListener() {
					@Override
					public void onClick(View v) {
						// 设置变换中心位于View的中心
		...
		findViewById(R.id.pivot_width_height).setOnClickListener(
				new OnClickListener() {
					@Override
					public void onClick(View v) {
						// 设置变换中心位于View的右下角
