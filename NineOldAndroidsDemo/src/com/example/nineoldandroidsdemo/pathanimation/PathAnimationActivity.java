 ...
 */
package com.example.nineoldandroidsdemo.pathanimation;
...
import com.example.nineoldandroidsdemo.R;
...
public class PathAnimationActivity extends Activity {
	 ...
	 * produces (a new "PathPoint" describing the current animated location) and
	 * the information that the button requires (an xy location). The setter
	 * will be called by the ObjectAnimator given the 'buttonLoc' property
	 * string.
	 */
