 ...
 * the proportion traveled between those points. The value of the interpolation
 * depends on the operation specified by the endValue (the operation for the
 * interval between PathPoints is always specified by the end point of that
 * interval).
 */
